...
checkpoints_dir=${checkpoints_dir:-"/mnt/lustre/chenghaoyue/projects/VisualVoice/checkpoints"}
...
display_freq=${display_freq:-5}
save_latest_freq=${save_latest_freq:-100}
validation_on=${validation_on:-"true"}
validation_freq=${validation_freq:-100}

weights_facial=${weights_facial:-"pretrained_models/cross-modal-pretraining/facial.pth"}
...
use_mixandseparate_loss=${use_mixandseparate_loss:-"true"}
use_sisnr_loss=${use_sisnr_loss:-"false"}
...
after_refine_ratio=${after_refine_ratio:-1.0}

refine_num_layers=${refine_num_layers:-1}
...
lr_facial_attributes=${lr_facial_attributes:-1e-5}
